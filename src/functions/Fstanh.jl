...
if PROC=="GPU" ## TODO
    ...
    Fstanh_inplace(handle,value::CudaArray,aux,x::CudaArray)=stanh!(sf,x,value)
    
    Dstanh(handle,derivativeIDX,f_c,faux_c,grad_c::CudaArray,grad_n::CudaArray,x::CudaArray)=Dstanh!(sf,grad_c,f_c,grad_n)
end
